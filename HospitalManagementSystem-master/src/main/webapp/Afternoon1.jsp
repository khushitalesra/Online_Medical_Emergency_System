...

{
                ...
                { 
                                ...
                                session.setAttribute("date",rs2.getString("Date"));  // Date from availability

                                if(rs2.getString("Slot").equals("A")&&rs2.getString("booked").equals("0"))
